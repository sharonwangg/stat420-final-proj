...
transformed_log_step_from_add = lm(log(total_confirmed) ~ stay_at_home_requirements + I(stay_at_home_requirements^2) + mobility_parks + mobility_transit_stations, data = clean_data_subset)
```
...
# 
# 
# clean_int_log_model = lm(log(total_confirmed) ~ (school_closing + cancel_public_events + stay_at_home_requirements + mobility_parks + mobility_transit_stations)^2, data = clean_without_influence)
